...
function ComentarioCollection(comentarioCollection, respuesta, comentarios){
	...
	this.toHTML = function(){
		...
		$.each(this.comentarios, function(i, v) {
			...
			html = html.concat('<li class="event"><input type="radio" name="tl-group" checked/><img id="ball" src="images/favicon.png"><div class="thumb user-4" background: "URLI"><span>'+ comentario.username +'</span></div>');
			...
			html = html.concat('<div class="deletecomment"><a class="boton verde" href="comentarios.html" onclick="getAnuncio(24)" id="borrar_com" align="right">Borrar Comentario id='+ idcomentario +'</a></div><br>');
